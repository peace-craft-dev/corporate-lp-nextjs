    ...
    <section id="contact" className="relative py-24 md:py-32 px-6">
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          {platforms.map((p, i) => (
            <motion.a
              ...
              className="group border-gradient p-5 md:p-6 hover:translate-y-[-2px] transition-transform"
            >
              <div className="flex items-start justify-between mb-3">
                <span className="text-[11px] tracking-[0.2em] uppercase text-ink-muted">
                  {p.badge}
                </span>
                <ArrowUpRight className="w-4 h-4 text-ink-muted group-hover:text-brand-400 transition-colors" />
              </div>
        ...
        <motion.div
          ...
          className="border-gradient p-6 md:p-10 text-center glow-brand"
        >
          <Mail className="w-7 h-7 text-brand-400 mx-auto mb-4" />
